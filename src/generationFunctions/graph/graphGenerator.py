...
def graphPlot(dirSaidaFig: Path, cod_curso: int, cod_subgrupo: int, options: list[str], percentage: list[float], num_pergunta: int, pergunta: str) -> Path:
    """
...
def controllerGraphGenerator(collectionName: Collection, opcoes: list[str], porcentagem: list[float], cod_curso: int, cd_subgrupo: int, nu_pergunta: int, pergunta:str) -> Path:
    """
