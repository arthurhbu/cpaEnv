...
def compor_introducao(collectionCentroPorAno: Collection,collectionCursosPorCentro: Collection, arquivo_intro: str, ano: int, centro_de_ensino: str) -> None:
    """
...
def compor_conclusão(collectionNameCursosPorCentro: Collection, arquivo_conclusao: str, ano: int) -> None:
    """
